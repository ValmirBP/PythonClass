...
print("\nWrite a Software that asks the user for their wage, the value of a house, and the payment schedule.")
print("""Calculate the value of the monthly payment that does not exceed 30 percent of their wage, as
